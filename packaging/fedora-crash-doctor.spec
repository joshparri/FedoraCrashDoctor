...
install -m 0644 app_crash_doctor.py symbolic_analysis.py incident_model.py incident_observations.py coredump_adapter.py graphics_doctor.py hardware_doctor.py memory_oom.py dadlan_doctor.py %{buildroot}%{_datadir}/fedora-crash-doctor/
