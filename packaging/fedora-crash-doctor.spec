...
install -m 0644 app_crash_doctor.py symbolic_analysis.py incident_model.py incident_observations.py change_correlation.py incident_fingerprint.py confidence_explanation.py incident_history.py coredump_adapter.py graphics_doctor.py hardware_doctor.py memory_oom.py dadlan_doctor.py %{buildroot}%{_datadir}/fedora-crash-doctor/
